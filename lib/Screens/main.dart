...
import 'package:app_perritos/Screens/refugio.dart';
  ...
  Widget build(BuildContext context) {
    return new SplashScreen(
      ...
      image: new Image.network(
          'https://leonidasrubio.colegiosonline.com/uploads/institucion/escudo.gif'),
    ...
    return Scaffold(
      ...
      drawer: Drawer(
        child: ListView(children: [
          DrawerHeader(
            child: Image.asset(
              'assets/images/Furry-Protected.GIF',
              fit: BoxFit.fitWidth,
            ),
        ...
        items: <Widget>[
          IconButton(
            icon: Icon(Icons.favorite,
                size: 30, color: Color.fromRGBO(255, 250, 91, 20)),
            onPressed: () {
              Navigator.push(
                context,
          ...
          IconButton(
            icon: Icon(Icons.account_balance, size: 30, color: Colors.white),
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
          ...
          IconButton(
            icon: Icon(Icons.business, size: 30, color: Colors.white),
            onPressed: () {
              Navigator.push(
                context,
