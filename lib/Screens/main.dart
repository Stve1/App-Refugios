...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return new SplashScreen(
      ...
      gradientBackground: new LinearGradient(colors: [
            ...
            ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => VeterinariasTienda()),
                  );
                }),
            ListTile(
              title: Padding(
                ...
                child: Row(children: [
                  Padding(
                    ...
                    child: Container(
                        ...
                        child: Image.asset(
                          'assets/images/Ibacrea.png',
                          height: 40,
                        )),
                  ),
                  Image.asset(
                    'assets/images/Devshouse.jpg',
                    height: 40,
                  )
                ]),
              ),
        ...
        items: <Widget>[
          IconButton(
            icon: Image.asset('assets/images/Huella.png',
                height: 30, color: Color.fromRGBO(255, 250, 91, 20)),
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => Animals()),
